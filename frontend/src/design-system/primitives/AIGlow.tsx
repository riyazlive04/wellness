...
export const AIGlow = forwardRef<HTMLDivElement, AIGlowProps>(
  ({ className, intensity = 'default', animated = true, children, ...rest }, ref) => {
    ...
    const intensityClass = {
      soft: 'shadow-[0_0_24px_-8px_rgba(109,176,34,0.25)]',
      default: 'shadow-[0_0_40px_-10px_rgba(109,176,34,0.45),_0_0_80px_-30px_rgba(109,176,34,0.25)]',
      strong: 'shadow-[0_0_60px_-10px_rgba(109,176,34,0.65),_0_0_120px_-30px_rgba(109,176,34,0.35)]',
    }[intensity];
      ...
      <motion.div
        ...
        animate={
          shouldAnimate
            ? {
                boxShadow: [
                  '0 0 40px -10px rgba(109,176,34,0.45), 0 0 80px -30px rgba(109,176,34,0.25)',
                  '0 0 56px -10px rgba(109,176,34,0.6), 0 0 100px -30px rgba(109,176,34,0.35)',
                  '0 0 40px -10px rgba(109,176,34,0.45), 0 0 80px -30px rgba(109,176,34,0.25)',
                ],
              }
            : undefined
