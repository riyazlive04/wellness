...
import { OrganizationActivityView } from '@/modules/organizations/OrganizationActivityView';

export default function OwnerOrganizationActivity() {
  ...
  return (
    <OwnerLayout
      ...
      trialDaysLeft={28}
      topbarContext="Platform · Organization audit"
    >
      <div className="mx-auto w-full max-w-6xl px-4 py-6 md:px-8 md:py-10">
        <OrganizationActivityView heroEyebrow="Platform · Audit trail" />
      </div>
    </OwnerLayout>
  );
}
