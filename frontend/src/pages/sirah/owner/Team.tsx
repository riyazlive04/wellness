      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-8 md:py-10">
        <motion.div variants={stagger(0.05, 0.04)} initial="initial" animate="animate" className="space-y-7">
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <span className="text-xs uppercase tracking-[0.18em] text-foreground/75 dark:text-foreground/55">Team</span>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-0.5 text-base font-medium text-foreground">
                      ...
                      <span className="ml-1 text-foreground/75 dark:text-foreground/60">of {PLAN_SEATS} on the {PLAN_NAME} plan</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-stretch gap-3 md:items-end">
                  ...
                  {seatsUsed >= PLAN_SEATS ? (
                    ...
                    <span className="text-xs text-foreground/75 dark:text-foreground/60">
            ...
            <Glass className="overflow-hidden">
              <div className="flex items-center justify-between border-b border-foreground/[0.06] px-5 py-4">
                <div>
                  ...
                  <div className="text-xs text-foreground/75 dark:text-foreground/60">Active and pending team accounts</div>
                </div>
              </div>

              {/* Header */}
              <div className="hidden grid-cols-[auto_1fr_140px_120px_120px_36px] gap-4 border-b border-foreground/[0.04] px-5 py-3 text-[10px] uppercase tracking-[0.18em] text-foreground/75 dark:text-foreground/55 md:grid">
                <div className="w-10" />
                <div>Name</div>
                <div>Role</div>
                <div>Load</div>
          ...
          <motion.div variants={fadeUp}>
            <div className="mb-3 flex items-end justify-between">
              <div>
                <div className="text-[10px] uppercase tracking-[0.18em] text-foreground/75 dark:text-foreground/55">Permissions</div>
            ...
            <div className="mt-3 flex items-center gap-4 text-[10px] text-foreground/75 dark:text-foreground/60">
