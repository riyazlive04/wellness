...
function ActionTile({ intent, onPick }: { intent: PromptIntent; onPick: () => void }) {
  ...
  return (
    ...
    >
      <div className="grid h-10 w-10 flex-shrink-0 place-items-center rounded-xl bg-gradient-to-br from-blue-600/20 to-fuchsia-500/15 text-violet-700 dark:text-violet-200 transition-colors group-hover:from-violet-500/30 group-hover:to-emerald-400/25">
