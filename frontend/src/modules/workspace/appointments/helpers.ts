...
> = {
  video:     { label: 'Video',     chip: 'border-teal-400/40 bg-teal-400/10 text-teal-700 dark:text-teal-200' },
...
export const STATUS_META: Record<
  ...
  { label: string; chip: string }
> = {
  scheduled: { label: 'Scheduled', chip: 'border-teal-400/40 bg-teal-400/10 text-teal-700 dark:text-teal-200' },
