...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    matrix: { owner: 'full', manager: 'none', coach: 'none' },
  },
  {
    id: 'manage_team',
    label: 'Invite + remove team members',
    description: 'Add new coaches/managers and change their roles.',
    matrix: { owner: 'full', manager: 'none', coach: 'none' },
  },
  {
    ...
    matrix: { owner: 'full', manager: 'partial', coach: 'none' },
  },
  {
    id: 'see_analytics',
