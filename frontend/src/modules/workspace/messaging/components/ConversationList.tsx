  ...
  return (
    <div className="flex h-full flex-col border-r border-foreground/[0.06] bg-canvas/60 backdrop-blur-md">
      ...
      <ul className="flex-1 overflow-y-auto">
        {filtered.length === 0 ? (
          <li className="p-8 text-center text-xs text-foreground/40">No conversations match "{query}"</li>
        ) : (
          filtered.map((c) => {
              ...
              <li key={c.id}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="truncate text-[11px] text-foreground/40">{c.program}</div>
