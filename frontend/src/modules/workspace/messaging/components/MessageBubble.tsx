      ...
      <div className="max-w-[80%] md:max-w-[70%]">
        <div
          className={cn(
            ...
            isOwner
              ? 'rounded-br-md bg-gradient-to-br from-[hsl(var(--brand-blue)_/_0.85)] to-[hsl(var(--brand-magenta)_/_0.80)] text-foreground shadow-[0_4px_18px_-4px_rgba(109,176,34,0.55)]'
    ...
    <div className="-mx-4 -mt-2.5 mb-2.5">
      {!failed ? (
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 50%, rgba(109,176,34,0.25), rgba(15,17,21,0.95))',
          }}
        >
