...
export const WORKFLOWS: Workflow[] = [
  {
    ...
    description: "When a client goes quiet for 3 days, SIRAH drafts a check-in for you to review and approve.",
    status: 'active',
    nodes: [
  ...
  },
  {
    ...
    description: "Routes uploaded meal photos straight to your review tray when SIRAH's confidence is low or the client is new.",
    status: 'active',
    nodes: [
