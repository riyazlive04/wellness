    ...
    <div className="space-y-6">
      ...
      <AIGlow intensity="soft" animated>
        <Glass variant="heavy" className="rounded-2xl">
          ...
          >
            <div className="grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-[hsl(var(--brand-blue)_/_0.25)] to-[hsl(var(--brand-magenta)_/_0.20)] text-teal-700 dark:text-teal-200">
