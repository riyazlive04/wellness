      ...
      <Glass className="flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-end gap-2 border-t border-foreground/[0.08] px-6 py-4">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-br from-blue-600 to-fuchsia-500 px-5 py-2 text-sm font-medium text-white hover:scale-[1.02] disabled:opacity-60"
          >
