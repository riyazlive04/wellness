    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/55 p-4 backdrop-blur-sm">
      <Glass className="flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden">
        <div className="flex items-start gap-3 border-b border-foreground/[0.08] px-6 py-4">
          <div className="grid h-9 w-9 flex-shrink-0 place-items-center rounded-lg bg-gradient-to-br from-[hsl(var(--brand-blue)_/_0.25)] to-[hsl(var(--brand-magenta)_/_0.20)] text-teal-700 dark:text-teal-200">
        ...
        <div className="flex items-center justify-end gap-2 border-t border-foreground/[0.08] px-6 py-4">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-br from-[hsl(var(--brand-blue))] to-[hsl(var(--brand-magenta))] px-5 py-2 text-sm font-medium text-white hover:scale-[1.02] cta-glow active:scale-[0.97] disabled:opacity-60"
          >
