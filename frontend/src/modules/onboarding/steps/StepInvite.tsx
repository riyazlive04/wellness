...
export function StepInvite() {
  ...
  return (
    <div className="space-y-6">
      <Glass className="p-6">
        {/* Channel toggle */}
        <div className="mb-5 flex rounded-full bg-white/[0.04] p-1">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <label className="block">
            <div className="mb-1.5 text-xs font-medium text-white/60">Client's name</div>
            <input
      ...
      <Glass variant="subtle" className="flex items-start gap-3 p-4 text-xs text-white/55">
        <div className="grid h-6 w-6 flex-shrink-0 place-items-center rounded-full bg-indigo-500/15 text-indigo-300">
          💡
        </div>
        <div>
          Not ready to invite anyone yet? <span className="text-white/80">Skip this step</span>.
