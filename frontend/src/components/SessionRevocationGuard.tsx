    ...
    <div className="fixed inset-0 z-[200] grid place-items-center bg-canvas/95 backdrop-blur-sm p-6">
      <div className="w-full max-w-sm rounded-2xl border border-foreground/10 bg-background p-6 text-center shadow-2xl">
        ...
        <button
          ...
          className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-gradient-to-br from-[hsl(var(--brand-blue))] to-[hsl(var(--brand-magenta))] px-5 py-2.5 text-sm font-medium text-white transition-transform hover:scale-[1.02] cta-glow active:scale-[0.97]"
        >
          Sign in again
        </button>
      </div>
