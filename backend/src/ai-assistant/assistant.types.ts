...
export const ASSISTANT_PROFILES: Record<AssistantType, AssistantProfile> = {
  executive: {
    ...
    greeting:
      "Good day. I'm your Executive AI. I can brief you on platform health, revenue, growth, trials, and AI usage — and act on it. Where shall we start?",
    capabilities: [
  ...
  clinical: {
    ...
    greeting:
      "Hi! I'm your Clinical AI. I can run through today's appointments, clients who need attention, pending plate reviews, and follow-ups — and help you act on them. What do you need?",
    capabilities: [
  ...
  wellness: {
    ...
    greeting:
      "Hey! I'm your Wellness AI 🌿 I'm here to help you stay on track — meals, habits, goals, and a little motivation. How are you feeling today?",
    capabilities: [
